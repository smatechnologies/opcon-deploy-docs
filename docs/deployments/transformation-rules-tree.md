...
![Build Options and Summary screen](/img/build-options-and-summary-screen.png)
...
![Rule Selection](/img/rule-selection-window.png)
...
![View a Transformation Rule1](/img/view-transformation-rule-1.png) 
...
![Server Rules](/img/server-rules.png) 
...
![Transformation Rule2](/img/view-transformation-rule-2.png)
...
![Server Rules Package](/img/server-rules-package.png)
...
![Package Transformation Rule](/img/deployment-package-transformation-rule.png)
...
![Package Deployment Transformation Tree ](/img/package-deployment-transformation-tree.png)
...
![Sample Simulate Report](/img/sample-simulate-report.png)
...
![Deploy Confirmation Message](/img/deploy-confirmation-message.png)
...
![Deployment Mismatch Message](/img/deployment-mismatch-message.png)
...
![Differences Example](/img/differences-example-2.png)
